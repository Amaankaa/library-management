...
public class Edit_Admin extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        cb.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "USER_ID", "NAME", "PASSWORD", "CONTACT" }));
        cb.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        ...
        jLabel1.setText("CHOOSE EDITABLE");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String query = "update admin set " + selected + "='" +input+"';";
        ...
        try {
            ...
            if (rows > 0){
                JOptionPane.showMessageDialog(this, " '" +selected+"' updated successfully!");
            } else {
